...
df = pd.read_csv('csv-raw/vhi_id_11_2018-05-27_01-37.csv', engine='python', delimiter='\,\s+|\,|\s+', skiprows=1,
                 index_col=False, names=["year", "week", "SMN", "SMK", "VCI", "TCI", "VHI", ])
...
# print df[(df['week'] == 10) & (df['VHI'] < 50) & (df['year'] == '2018')]
